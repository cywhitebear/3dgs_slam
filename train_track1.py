...
from scene.dataset_readers_track1 import Dataset
...
if __name__ == "__main__":
    ...
    data_dir = "/media/ee904/DATA1/Track1_gs"
    output_dir = "output_track1"
    ...
    trainer.train(num_epochs=30, batch_size=8)
    trainer.save_ply("gaussian_reconstruction_track1.ply")
    print("\nTraining complete!")
